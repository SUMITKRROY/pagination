...
import 'package:pagination/utils.dart';
...
/*class _PaginationPageState extends State<PaginationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    BlocProvider.of<PaginationPageBloc>(context).loadPosts();
    return MediaQuery(data: MediaQuery.of(context).copyWith(textScaleFactor: 1.0), child: Scaffold(

body: BlocBuilder<PaginationPageBloc, PaginationPageState>(
...
//  PageController _pageController = PageController(initialPage: 1, viewportFraction: 0.4);
  ...
  @override
  void initState() {
    BlocProvider.of<PaginationBloc>(context).loadPosts();
    // wishvalue =
